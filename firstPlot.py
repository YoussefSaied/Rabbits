...
to_ploty_rabbits2 = []
# to_ploty_energy = []
to_plotx = [i for i in range(10, 26)] +  [i for i in range(30, 110, 10)] + [i for i in range(150, 1050, 50)]
...
X = np.array([i for i in range(30, 110, 10)] + [i for i in range(150, 300, 50)]).reshape(-1, 1)
...
X2 = np.array([i for i in range(30, 110, 10)] + [i for i in range(150, 1050, 50)]).reshape(-1, 1)
pred2 = X2 * coef1 + coef2
...
ax2.plot([i for i in range(30, 110, 10)] + [i for i in range(150, 1050, 50)], pred2, color=color, linestyle='dashed', label='Line of best fit')
